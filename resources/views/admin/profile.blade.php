                ...
                <div class="col-md-10">
                    ...
                    <div class="card border-0 shadow-lg rounded-4 overflow-hidden py-4">
                            ...
                            <div class="position-absolute bottom-0 start-50 translate-middle-x mb-3">
                                <div class="text-center">
                                    @if (Auth::guard('admin')->user()->photo)
                                        <img src="{{ asset('media/admin/' . Auth::guard('admin')->user()->photo) }}"
                        ...
                        <div class="card-body px-4 px-md-5 text-center text-md-start">
                            <div class="text-center">
                                <h2 class="fw-bold text-dark mb-1">{{ Auth::guard('admin')->user()->name }}</h2>
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex align-items-center gap-3 p-3 rounded-3 bg-light">
                                        ...
                                        <div>
                                            ...
                                            <strong>#TCH{{ str_pad(Auth::guard('admin')->user()->id, 4, '0', STR_PAD_LEFT) }}</strong>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="d-flex align-items-center gap-3 p-3 rounded-3 bg-light">
                                        ...
                                        <div>
                                            ...
                                            <strong>{{ Auth::guard('admin')->user()->phone ?? 'Not provided' }}</strong>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex align-items-center gap-3 p-3 rounded-3 bg-light">
                                        ...
                                        <div>
                                            ...
                                            <strong>{{ Auth::guard('admin')->user()->created_at->format('d M, Y') }}</strong>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex flex-wrap gap-3 justify-content-center">
                                <a href="{{ route('edit.admin') }}" class="btn btn-success btn-lg px-5 rounded-3 shadow-sm hover-lift">
